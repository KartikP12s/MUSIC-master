  ...
  return (
    <div className='main-container'>
      ...
      <div ref={modalRef} className={`on-click-modal-container ${showModal ? 'active' : ''}`}>
        <div className='account-settings'><p className='account-setting-text'>Settings</p></div>
        <div onClick={handleLogout} className='logout-button'><p className='account-setting-text' >Log out</p></div>
      </div>
    </div>
  );
}
